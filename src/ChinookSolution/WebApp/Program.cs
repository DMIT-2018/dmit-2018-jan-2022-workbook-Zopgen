...
//  web app to use indavidual accounts
...
//registers the connection string for Indavidual accounts
...
//the etension method will have a parameter: options.UseSqlServer()
