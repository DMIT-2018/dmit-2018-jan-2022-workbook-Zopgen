...
namespace ChinookSystem.BLL
{
    public class AlbumServices
    {
                                                ...
                                                out int totalrows)
        {
            ...
            //the paginator for this application determines the lines to return 
            //  to the page model for processing
            ...
            //calculate the cumber of rows to skip in the query collection
